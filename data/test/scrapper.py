...
urltail += '&results=1000&order=TotalSales&direction=DESC&showtotalsales=0&showtotalsales=1&showpublisher=0'
...
for page in range(1, pages):
    ...
    for i in soup.find_all("a",href=True):
        if i["href"].startswith('https://www.vgchartz.com/game/'):
            game_tags.append(i)
...
df = df[[
    ...
    'Publisher', 'Critic_Score','NA_Sales', 
